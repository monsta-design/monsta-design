...
@Component({
  selector: 'ns-demo-drawer-top',
  template: `
    <button nsButton="secondary" nsButtonOutline="true" nsButtonSize="sm" (click)="toggle()">打开</button>
    <div class="container">
      <ns-drawer nsPlacement="t" [nsHeight]="100" [nsVisible]="visible" (nsOnClose)="visible = false" [nsMask]="true">drawer</ns-drawer>
...
export class NSDemoDrawerTopComponent implements OnInit {
