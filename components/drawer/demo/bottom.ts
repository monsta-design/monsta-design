...
@Component({
  selector: 'ns-demo-drawer-bottom',
  template: `
    ...
    <div class="container">
      ...
      <ns-drawer nsPlacement="b" [nsHeight]="100" [nsVisible]="visible" (nsOnClose)="visible = false" [nsMask]="true">drawer</ns-drawer>
    </div>
  `,
  styles: [`
    .container {
...
export class NSDemoDrawerBottomComponent implements OnInit {
