...
@Component({
  selector: 'ns-demo-drawer-start',
  template: `
    <button nsButton="secondary" nsButtonOutline="true" nsButtonSize="sm" (click)="toggle()">打开</button>
    <div class="container">
      <ns-drawer nsPlacement="s" [nsWidth]="500" [nsVisible]="visible" (nsOnClose)="visible = false" [nsMask]="true">drawer</ns-drawer>
...
export class NSDemoDrawerStartComponent implements OnInit {
